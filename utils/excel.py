...
class Excel:
    ...
    def run(self, file_dir='Output/Expenses', output_type=None):  # todo 类型2报价单需要添加
        ...
        if output_type == 1:
            ...
            sheet1.insert_image(row + 1, 0, 'img\\stamp1.png', {'x_offset': 40, 'x_scale': 0.92, 'object_position': 2})
            ...
            sheet2.insert_image(row, 1, 'img\\stamp1.png', {'y_scale': 1.1, 'x_scale': 0.92, 'object_position': 2})
